...
export interface ClientOptions {
  ...
  /**
   * A function to map keys to servers.
   * NOTE: if you need to do some expensive initialization, *please* do it lazily
   * the first time you this function is called with an array of serverKeys, not on
   * every call.
   */
  keyToServerHashFunction?: (serverKeys: string[], key: string) => string;
}
