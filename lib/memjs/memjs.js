...
Client.prototype.set = function(key, value, callback) {
  var extras = Buffer.concat([new Buffer('00000000', 'hex'),
                              makeExpiration(this.options.expires)]);
...
Client.prototype.flush = function(callback) {
  ...
  for (i in this.servers) {
    ...
    serv.onResponse(function statsHandler(response) {
        callback && callback(null, result);
    });
    serv.onError(function(err) {
...
Client.prototype.perform = function(serv, request, callback, retries) {
  ...
  serv.onResponse(responseHandler);
  serv.onError(errorHandler);
  serv.write(request);
}
