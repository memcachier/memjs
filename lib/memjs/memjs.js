...
Client.prototype.get = function(key, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.get(key, function(err, val) { err ? reject(err) : resolve(val) }))
...
Client.prototype.set = function(key, value, options, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.set(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }))
  var logger = this.options.logger;
  var expires;
...
Client.prototype.add = function(key, value, options, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.add(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }))
  var logger = this.options.logger;
  var expires;
...
Client.prototype.replace = function(key, value, options, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.replace(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }))
  var logger = this.options.logger;
  var expires;
  if (typeof options === 'function') {
    // OLD: function(key, value, callback, expires)
...
Client.prototype.delete = function(key, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.delete(key, function(err, val) { err ? reject(err) : resolve(val) }))
...
Client.prototype.increment = function(key, amount, options, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.increment(key, amount, options, function(err, val) { err ? reject(err) : resolve(val) }))
  var logger = this.options.logger;
  var initial;
  var expires;
  if (typeof options === 'function') {
...
Client.prototype.decrement = function(key, amount, options, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.decrement(key, amount, options, function(err, val) { err ? reject(err) : resolve(val) }))
  // TODO: support version (CAS)
  var logger = this.options.logger;
  var initial;
  var expires;
...
Client.prototype.append = function(key, value, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.append(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }))
  // TODO: support version (CAS)
  var logger = this.options.logger;
  this.seq++;
...
Client.prototype.prepend = function(key, value, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.prepend(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }))
  // TODO: support version (CAS)
  var logger = this.options.logger;
  this.seq++;
  var request = makeRequestBuffer(0x0E, key, '', value, this.seq);
...
Client.prototype.touch = function(key, expires, callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.touch(key, expires, function(err, val) { err ? reject(err) : resolve(val) }))
  // TODO: support version (CAS)
  var logger = this.options.logger;
  this.seq++;
...
Client.prototype.flush = function(callback) {
  if(callback === undefined) return new Promise((resolve, reject) => this.flush(function(err, val) { err ? reject(err) : resolve(val) }))
