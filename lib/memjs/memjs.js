...
var nonSerialization = require('./serializers/non-serialization');
...
Client.prototype.get = function(key, callback) {
  ...
  this.seq++;
  var request = makeRequestBuffer(0, key, '', '', this.seq, this.serializer);
...
Client.prototype.set = function(key, value, options, callback) {
  ...
  var request = makeRequestBuffer(1, key, extras, value, this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
...
Client.prototype.add = function(key, value, options, callback) {
  ...
  var expiration = makeExpiration(expires || this.options.expires);
  var extras = Buffer.concat([Buffer.from('00000000', 'hex'), expiration]);
  var request = makeRequestBuffer(2, key, extras, value, this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.replace = function(key, value, options, callback) {
  ...
  var expiration = makeExpiration(expires || this.options.expires);
  var extras = Buffer.concat([Buffer.from('00000000', 'hex'), expiration]);
  var request = makeRequestBuffer(3, key, extras, value, this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.delete = function(key, callback) {
  ...
  var logger = this.options.logger;
  this.seq++;
  var request = makeRequestBuffer(4, key, '', '', this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.increment = function(key, amount, options, callback) {
  ...
  var request = makeRequestBuffer(5, key, extras, '', this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.decrement = function(key, amount, options, callback) {
  ...
  expires = expires || this.options.expires;
  var extras = makeAmountInitialAndExpiration(amount, initial, expires);
  var request = makeRequestBuffer(6, key, extras, '', this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.append = function(key, value, callback) {
  ...
  var logger = this.options.logger;
  this.seq++;
  var request = makeRequestBuffer(0x0E, key, '', value, this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.touch = function(key, expires, callback) {
  ...
  var request = makeRequestBuffer(0x1C, key, extras, '', this.seq, this.serializer);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.flush = function(callback) {
  ...
  this.seq++;
  var request = makeRequestBuffer(0x08, '', '', '', this.seq, this.serializer);
...
Client.prototype.statsWithKey = function(key, callback) {
  var logger = this.options.logger;
  this.seq++;
  var request = makeRequestBuffer(0x10, key, '', '', this.seq, this.serializer);
  var i;
...
Client.prototype.quit = function() {
  ...
  // write is done.
  var request = makeRequestBuffer(0x07, '', '', '', this.seq, this.serializer); // QUIT
  var serv;
  var i;
