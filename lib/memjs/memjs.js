...
Client.prototype.append = function(key, value, callback) {
  if(callback === undefined) {     
    var self = this;     
    return new Promise(function(resolve, reject) { self.append(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }) })
  }
  // TODO: support version (CAS)
  var logger = this.options.logger;
  this.seq++;
...
Client.prototype.prepend = function(key, value, callback) {
  if(callback === undefined) {     
    var self = this;     
    return new Promise(function(resolve, reject) { self.prepend(key, value, options, function(err, val) { err ? reject(err) : resolve(val) }) })
  }
  // TODO: support version (CAS)
  var logger = this.options.logger;
  this.seq++;
