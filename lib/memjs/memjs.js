...
// callback is invoked with the arguments _value_, _extras_, both Buffers. If
// the key is not found, the callback is invoked with null for both arguments.
// If there is a different error, the error is logged to the console and the
// callback is invoked with no arguments (i.e. both are undefined).
