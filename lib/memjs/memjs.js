...
Client.create = function(serversStr, options) {
  var servers = Client.createServers(serversStr, options);
  return new Client(servers, options);
};


Client.createServers = function(serversStr, options) {
  ...
  return serversStr
    .split(',')
    .map(function(uri) {
      return Server.create(uri, options);
    });
};
...
Client.prototype.get = function(key, callback) {
  ...
  this.seq++;
  var request = this.serialize(0, key, '', '', this.seq);
...
Client.prototype.set = function(key, value, options, callback) {
  ...
  var request = this.serialize(1, key, extras, value, this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
...
Client.prototype.add = function(key, value, options, callback) {
  ...
  var expiration = makeExpiration(expires || this.options.expires);
  var extras = Buffer.concat([Buffer.from('00000000', 'hex'), expiration]);
  var request = this.serialize(2, key, extras, value, this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.replace = function(key, value, options, callback) {
  ...
  var expiration = makeExpiration(expires || this.options.expires);
  var extras = Buffer.concat([Buffer.from('00000000', 'hex'), expiration]);
  var request = this.serialize(3, key, extras, value, this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.delete = function(key, callback) {
  ...
  var logger = this.options.logger;
  this.seq++;
  var request = this.serialize(4, key, '', '', this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null, null); }
      return;
...
Client.prototype.increment = function(key, amount, options, callback) {
  ...
  var request = this.serialize(5, key, extras, '', this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.decrement = function(key, amount, options, callback) {
  ...
  expires = expires || this.options.expires;
  var extras = makeAmountInitialAndExpiration(amount, initial, expires);
  var request = this.serialize(6, key, extras, '', this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.append = function(key, value, callback) {
  ...
  var logger = this.options.logger;
  this.seq++;
  var request = this.serialize(0x0E, key, '', value, this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.touch = function(key, expires, callback) {
  ...
  var request = this.serialize(0x1C, key, extras, '', this.seq);
  this.perform(key, request, this.seq, function(err, response) {
    if (err) {
      if (callback) { callback(err, null); }
      return;
...
Client.prototype.flush = function(callback) {
  ...
  this.seq++;
  var request = this.serialize(0x08, '', '', '', this.seq);
...
Client.prototype.statsWithKey = function(key, callback) {
  var logger = this.options.logger;
  this.seq++;
  var request = this.serialize(0x10, key, '', '', this.seq);
  var i;
...
Client.prototype.quit = function() {
  ...
  // write is done.
  var request = this.serialize(0x07, '', '', '', this.seq); // QUIT
  var serv;
  var i;
...
Client.prototype.serialize = function(opcode, key, extras, value, opaque) {
  return makeRequestBuffer(opcode, key, extras, value, opaque);
};
...
Client.prototype.perform = function(key, request, seq, callback, retries) {
  ...
  var responseHandler = function(response) {
    if (callback) {
      callback(null, _this.deserialize(response));
    }
  };
...
Client.prototype.deserialize = function(response) {
  return response;
};
