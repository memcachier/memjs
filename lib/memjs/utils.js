...
var memjsBuffer = require('./buffer');
var bufferify = require('./buffer').bufferify;
...
exports.makeRequestBuffer = function(opcode, key, extras, value, opaque) {
  ...
  var buf = memjsBuffer.alloc(24 + key.length + extras.length + value.length);
  var requestHeader = {
    magic: 0x80,
    opcode: opcode,
